...
int main(int argc, char **argv)
{
     ...
     * VM's bytecode. This bytecode also stores static data, one in one region,
     * two in the second region, both of which are 32 bits in size.
     */
    unsigned char buffer[75] =
    {
        ...
        /* Static Segment Size of 0x1 */
        0x00, 0x00, 0x00, 0x02,
        /* Static Segment 0x1:0x0 */
        0x04, 0x00, 0x00, 0x00, 0x02,
        /* Static Segment 0x1:0x0 */
        0x04, 0x00, 0x00, 0x00, 0x0A,
        /* Heap Size */
        0x00, 0x00, 0x00, 0x00,
        /* LOAD GPR0 I32 0 */
        ...
        /* LOAD GPR2 I32 10 */
        0x02, 0x02, 0x04, 0x00, 0x00, 0xFF, 0xFE,
        /* LOAD GPR3 I32 28 */
